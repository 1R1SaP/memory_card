...
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QLineEdit, QListWidget, QLabel, QTextEdit, QLineEdit, QHBoxLayout, QVBoxLayout, QFormLayout, QInputDialog
...
def del_tag():
    if list_notes.selectedItems():
        ...
        list_tags.addItems(notes[key]["теги"])
        with open("notes_data.json", "w") as file:
            json.dump(tag, file, sort_keys=True, ensure_ascii=False)
    else:
